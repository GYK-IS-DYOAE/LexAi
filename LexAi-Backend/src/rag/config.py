...
TOP_K_OS = 10                      # OpenSearch’ten kaç sonuç alınsın
TOP_K_QDRANT = 10                  # Qdrant’tan kaç sonuç alınsın
MMR_LAMBDA = 0.5                   # MMR denge katsayısı (0=çeşitlilik, 1=benzerlik)
DEFAULT_TOPN = 5                   # Kullanıcıya gösterilecek sonuç sayısı
...
LLM_TIMEOUT = 120                  # İstek zaman aşımı (saniye)
